...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registroentrada`(in _usr varchar(20))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `salidabiblioteca`()
begin
...
CREATE TABLE IF NOT EXISTS `bitacora` (
  `serial` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bitacora` (`serial`, `login`, `fecha_ingreso`, `fecha_salida`) VALUES
(0000000001, 'prueva1', NULL, '2015-12-03 19:55:09'),
(0000000002, 'prueba2', '2015-12-03 20:41:24', NULL),
(0000000003, '', '2015-12-03 20:44:57', NULL),
(0000000004, '', '2015-12-03 20:45:11', NULL),
(0000000005, '', '2015-12-03 20:46:10', '2015-12-03 20:49:07'),
(0000000006, '', '2015-12-03 20:51:53', '2015-12-03 21:21:00');
